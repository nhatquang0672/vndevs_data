...
exports.ActShopFushiCModel = void 0;
 ...
 * 符石商店 - 符石币
 */
class ActShopFushiCModel extends AModel_1.AModel {
    constructor() {
        super(...arguments);
        this.table = "act"; //数据库表名
        this.kid = "actShopFushiC"; //用于存储key 和  输出1级key
    ...
    async getInfo() {
        ...
        if (info.dayAt < this.ctx.state.new0) {
            ...
            let cfgPool = gameCfg_1.default.shopFushic.pool;
    ...
    async buy(dc) {
        let info = await this.getInfo();
        let cfg = gameCfg_1.default.shopFushic.getItem(dc);
        if (cfg == null) {
            this.ctx.throw("参数错误");
            return;
        }
...
exports.ActShopFushiCModel = ActShopFushiCModel;
//# sourceMappingURL=ActShopFushiCModel.js.map