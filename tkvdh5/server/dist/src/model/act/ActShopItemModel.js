...
exports.ActShopItemModel = void 0;
 ...
 * 商店 - 道具
 */
class ActShopItemModel extends AModel_1.AModel {
    constructor() {
        super(...arguments);
        this.table = "act"; //数据库表名
        this.kid = "actShopItem"; //用于存储key 和  输出1级key
    ...
    */
    async buy(dc, count) {
        let info = await this.getInfo();
        let cfg = gameCfg_1.default.shopItem.getItem(dc);
        if (cfg == null) {
            this.ctx.throw("参数错误");
            return;
        }
...
exports.ActShopItemModel = ActShopItemModel;
//# sourceMappingURL=ActShopItemModel.js.map