...
exports.HdDouLuoLogModel = void 0;
 ...
 * HdDouLuoLogLogModel
 */
class HdDouLuoLogModel extends AModel_1.AModel {
    constructor() {
        super(...arguments);
        this.table = "hd"; //数据库表名
        this.kid = "hdDouLuoLog"; //用于存储key 和  输出1级key
...
exports.HdDouLuoLogModel = HdDouLuoLogModel;
//# sourceMappingURL=HdDouLuoLogModel.js.map