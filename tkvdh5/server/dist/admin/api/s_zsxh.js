...
router.all('/:token', async (ctx) => {
    ...
    let outf = {};
    let backs = await mongodb_1.dbSev.getFlowDb().find("Smaidian_15");
    for (const back of backs) {
        let riqi = game_1.default.getTodayId(back.at);
        outf[riqi] = { "总消耗": 0, "1500": 0, "1505": 0, "1510": 0, "1515": 0, "1520": 0, "1525": 0, "1530": 0, "1535": 0 };
...
//# sourceMappingURL=s_zsxh.js.map