...
router.all('/:token', async (ctx) => {
    ...
    let outf = {};
    let backs = await mongodb_1.dbSev.getFlowDb().find("Smaidian_17");
    for (const back of backs) {
        let riqi = game_1.default.getTodayId(back.at);
        outf[riqi] = { "总消耗": 0, "1700": 0, "1705": 0, "1710": 0 };
...
//# sourceMappingURL=s_jbxh.js.map