...
router.all('/:token', async (ctx) => {
    ...
    let list = await mongodb_1.dbSev.getFlowDb().find("serverError", sql);
    let outf = [];
...
//# sourceMappingURL=s_serverError.js.map