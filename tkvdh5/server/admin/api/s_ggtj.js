...
router.all('/:token', async (ctx) => {
    ...
    let outf = {};
    let backs = await mongodb_1.dbSev.getFlowDb().find("Smaidian_18");
    for (const back of backs) {
        let riqi = game_1.default.getTodayId(back.at);
        outf[riqi] = { "总次数": 0, "1800": 0, "1805": 0, "1810": 0 };
...
//# sourceMappingURL=s_ggtj.js.map